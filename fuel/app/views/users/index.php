<?php echo Form::open('users/form');  ?>
	...
	<div class="red textsize11 box" style="margin-bottom:10px;">
            4/26：簡単に予約できるように予約機能をバージョンアップしました。行くかも？を追加しました。行くかも？はユーザー一覧には表示されませんが、人数には反映されます。
            行けるか不明な場合などにお使いください。
            <br>今までのように時間を詳細に入力したい場合は到着時間詳細にチェックを入れると入力メニューが表示されます。
            <br>店舗一覧を都道府県別に表示し、見やすくしました。
	</div>
