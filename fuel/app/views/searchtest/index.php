...
<?php echo Form::open('searchtest/search');  ?>
...
<?php endif; ?>
    ...
    <tr><td>【ゲーム選択】<br />
		...
		<?php	if(isset($game)):		?>
		<?php echo \Form::select('game', $game,Controller_Searchtest::arr_game(),array('class' => 'span4')); ?>
		<?php	else:	?>
		<?php echo \Form::select('game', Input::post('game'),Controller_Searchtest::arr_game(),array('class' => 'span4')); ?>
		<?php	endif;	?>
		</td></tr>
    </tbody>
    </table>
