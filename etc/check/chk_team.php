...
//----------------------------------------------------------------------------------------
$IO_Table["team_name"] = 'TEXT, 0, , , NULL';
$IO_Table["name_1"] = 'TEXT, 0, , , NULL';
$IO_Table["name_2"] = 'TEXT, 0, , , NULL';
$IO_Table["name_3"] = 'TEXT, 0, , , NULL';

$IO_Table["chara_1"] = 'SELECT, 0, , , NULL';
$IO_Table["chara_2"] = 'SELECT, 0, , , NULL';
$IO_Table["chara_3"] = 'SELECT, 0, , , NULL';

if($f->chara_1 != "" && $f->chara_2 != "" && $f->chara_3 != ""){
	$IO_Table["chara_check"] = 'SELECT, 0,'.(($f->chara_1 != $f->chara_2) && ($f->chara_1 != $f->chara_3) && ($f->chara_2 != $f->chara_3)). ', , BOOL';
...
/* エラーメッセージ定義
----------------------------------------------------------------*/
define('Err_team_name', '※チーム名を入力してください。');
define('Err_name_1', '※エントリーネーム(1人目)を入力してください。');
define('Err_chara_1', '※使用キャラクター(1人目)を選択してください。');
define('Err_name_2', '※エントリーネーム(2人目)を入力してください。');
define('Err_chara_2', '※使用キャラクター(2人目)を選択してください。');
define('Err_name_3', '※エントリーネーム(3人目)を入力してください。');
define('Err_chara_3', '※使用キャラクター(3人目)を選択してください。');
define('Err_chara_check_BOOL', '※チーム内での同キャラは禁止です。');
